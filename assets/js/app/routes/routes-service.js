...
(function() {
  ...
  angular.module('frontend.routes').service('RoutesService', [
    '$log',
    '$state',
    '$http',
    'Semver',
      ...
      return {
        getProperties: function(version) {
          ...
          var props =
            properties[fver] ||
            properties[
              Object.keys(properties)[Object.keys(properties).length - 1]
            ];
        ...
        getLastAvailableFormattedVersion: function(version) {
          ...
          var existing =
            Object.keys(properties).indexOf(fver) >= 0
              ? fver
              : Object.keys(properties)[Object.keys(properties).length - 1];
        ...
        updatePlugin: function(routeId, pluginId, data) {
          ...
          return $http.patch(
            'kong/routes/' + routeId + '/plugins/' + pluginId,
            data
          );
        },
